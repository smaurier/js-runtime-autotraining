...
type PromiseState = typeof PENDING | typeof FULFILLED;

class MyPromise {
  _state: PromiseState;
  _value: any;
  _callbacks: Array<{ onFulfilled: ((value: any) => any) | null; resolve: (value: any) => void }>;
   ...
   */
  then(onFulfilled: ((value: any) => any) | null): MyPromise {
