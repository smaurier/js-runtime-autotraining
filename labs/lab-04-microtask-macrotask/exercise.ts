...
function checkPrediction(name: string, prediction: any[], actual: any[], phaseMap: Record<string, string>): void {
  total++;
...
function runPuzzle(name: string, prediction: any[], fn: (log: (msg: any) => void) => void, phaseMap?: Record<string, string>): Promise<void> {
...
function alternateQueues(count: number): Promise<string[]> {
  return new Promise((resolve) => {
...
function microtaskBomb(): Promise<void> {
  return new Promise((resolve) => {
