...
function checkPrediction(name: string, prediction: any[], actual: any[]): void {
  total++;
...
function runPuzzle(name: string, prediction: any[], fn: (log: (msg: any) => void) => void): Promise<void> {
