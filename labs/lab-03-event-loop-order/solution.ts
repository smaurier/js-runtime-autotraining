...
function checkPrediction(snippetName: string, prediction: any[], actual: any[]): void {
  total++;
...
function runSnippet(name: string, prediction: any[], fn: (log: (msg: any) => void) => void): Promise<void> {
