...
// =============================================================================
// Commande : node --allow-natives-syntax solution.js
//
...
console.log('1A - Meme forme {x, y} :', %HaveSameMap(obj1a, obj1b)); // true
...
const obj2a = { x: 1, y: 2 };
const obj2b = { y: 2, x: 1 };
console.log('1B - Ordre different {x,y} vs {y,x} :', %HaveSameMap(obj2a, obj2b)); // false
...
const obj3b = { x: 1, y: 2 };
obj3b.z = 3;
console.log('1C - Apres ajout dynamique de z :', %HaveSameMap(obj3a, obj3b)); // false
...
console.log('1D - Smi vs Double :', %HaveSameMap(obj4a, obj4b));
...
delete obj5b.z;
console.log('1E - Apres delete :', %HaveSameMap(obj5a, obj5b)); // false
...
console.log('1F - Instances de la meme classe :', %HaveSameMap(p1, p2)); // true
...
console.log('3A - Ordre different :', %HaveSameMap(objA1, objA2)); // false
...
console.log('3B - Apres delete :', %HaveSameMap(objB1, objB2)); // false
...
console.log('3C - Apres defineProperty :', %HaveSameMap(objC1, objC2)); // false
...
function badCreateUser(name, age, options = {}) {
  const user = {};
...
console.log('  badUser1 vs badUser2 :', %HaveSameMap(badUser1, badUser2)); // false
console.log('  badUser1 vs badUser3 :', %HaveSameMap(badUser1, badUser3)); // false
console.log('  badUser1 vs badUser4 :', %HaveSameMap(badUser1, badUser4)); // false
...
function goodCreateUser(name, age, options = {}) {
  return {
...
console.log('  goodUser1 vs goodUser2 :', %HaveSameMap(goodUser1, goodUser2)); // true
console.log('  goodUser1 vs goodUser3 :', %HaveSameMap(goodUser1, goodUser3)); // true
console.log('  goodUser1 vs goodUser4 :', %HaveSameMap(goodUser1, goodUser4)); // true

// Benchmark comparatif
function accessUserFields(user) {
...
function createUserLiteral(name, age, active) {
...
function createUserFromProto(name, age, active) {
...
console.log('  class[0] vs class[1] :', %HaveSameMap(classUsers[0], classUsers[1]));       // true
console.log('  literal[0] vs literal[1] :', %HaveSameMap(literalUsers[0], literalUsers[1])); // true
console.log('  proto[0] vs proto[1] :', %HaveSameMap(protoUsers[0], protoUsers[1]));         // true
console.log('  class[0] vs literal[0] :', %HaveSameMap(classUsers[0], literalUsers[0]));     // false
console.log('  class[0] vs proto[0] :', %HaveSameMap(classUsers[0], protoUsers[0]));         // false
