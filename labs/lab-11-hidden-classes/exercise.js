...
// =============================================================================
// Commande : node --allow-natives-syntax exercise.js
//
...
console.log('  1A - Même forme {x, y} :', %HaveSameMap(obj1a, obj1b));
...
// VOTRE PRÉDICTION : _____
console.log('  1B - Ordre différent {x,y} vs {y,x} :', %HaveSameMap(obj2a, obj2b));
...
// VOTRE PRÉDICTION : _____
console.log('  1C - Après ajout dynamique de z :', %HaveSameMap(obj3a, obj3b));
...
// VOTRE PRÉDICTION : _____
console.log('  1E - Après delete :', %HaveSameMap(obj5a, obj5b));
...
// VOTRE PRÉDICTION : _____
console.log('  1F - Instances de la même classe :', %HaveSameMap(p1, p2));
...
// Puis console.log(%HaveSameMap(a, b));
...
console.log('  badUser1 vs badUser2 :', %HaveSameMap(badUser1, badUser2));
console.log('  badUser1 vs badUser3 :', %HaveSameMap(badUser1, badUser3));
console.log('  badUser1 vs badUser4 :', %HaveSameMap(badUser1, badUser4));
...
//
// console.log('  goodUser1 vs goodUser2 :', %HaveSameMap(goodUser1, goodUser2));
// console.log('  goodUser1 vs goodUser3 :', %HaveSameMap(goodUser1, goodUser3));
// console.log('  goodUser1 vs goodUser4 :', %HaveSameMap(goodUser1, goodUser4));
//
// console.assert(%HaveSameMap(goodUser1, goodUser2), 'goodUser1 et goodUser2 doivent avoir la même map');
// console.assert(%HaveSameMap(goodUser1, goodUser3), 'goodUser1 et goodUser3 doivent avoir la même map');
// console.assert(%HaveSameMap(goodUser1, goodUser4), 'goodUser1 et goodUser4 doivent avoir la même map');
...
// Assertions attendues (décommentez après implémentation) :
// console.assert(%HaveSameMap(classUsers[0], classUsers[1]), 'instances de classe : même map');
// console.assert(%HaveSameMap(literalUsers[0], literalUsers[1]), 'literals : même map');
// console.assert(%HaveSameMap(protoUsers[0], protoUsers[1]), 'Object.create : même map');
// console.assert(!%HaveSameMap(classUsers[0], literalUsers[0]), 'classe vs literal : maps différentes');
