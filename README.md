...
| 02 | [`lab-02-fuite-memoire`](labs/lab-02-fuite-memoire/README.md) | Intervention | dans un composant existant | ✅ vérifié |
| 03 | [`lab-03-event-loop-bloque`](labs/lab-03-event-loop-bloque/README.md) | Intervention | en prod, diagnostic et correction | ✅ vérifié |
